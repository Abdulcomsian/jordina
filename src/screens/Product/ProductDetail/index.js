...
const ProductDetail = (props) => {
  ...
  const { allProduct, addProductFlag } = props;
  console.log("sdsa", addProductFlag);
  ...
  const addToCartHandler = () => {
    setShowLoader(true);
    props.addToCart(state.id, allProduct);
  };
  useEffect(() => {
    (async () => {
      if (state) {
      ...
      if (addProductFlag) {
        ...
        toast.success("Product Add SuccessFully !".toString(), {
          position: "top-right",
          autoClose: 5000,
      ...
      <div className="home_main-section">
        ...
        <main>
          <div className="main__wrapper">
            <div className="main__banner--section" style={{ height: 120 }}>
                  ...
                  <Col md={6}>
                    <div className="common__content">
                      ...
                      <p>
                        ...
                        arcu nunc ut habitant magna elementum turpis et eros.
                        Odio porta at nisl ultrices sed tellus.
                      </p>
                    </div>
                  </Col>
                  <Col md={6}>
...
const mapStateToProps = (state) => ({
  ...
  addProductFlag: state.cartReducer.addProduct,
});

const mapDispatchToProps = (dispatch) => ({
  addToCart: (id, allProduct) => {
    dispatch(addToCart(id, allProduct));
  },
});
