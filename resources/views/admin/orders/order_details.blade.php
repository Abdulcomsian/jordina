                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-center flex-column mb-5">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">Max
                                        Smith</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                                ...
                                                <div id="kt_customer_view_payment_method_{{$item->id}}"
                                                    ...
                                                    <div class="row py-5">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="d-flex mb-3">
                                                                <!--begin::Label-->
                                                                <div class="text-gray-400 fw-bold w-200px">Quantity</div>
                                                                <!--end::Label-->
                                                                <!--begin::Value-->
                                                            ...
                                                            <div class="d-flex mb-3">
                                                                <!--begin::Label-->
                                                                <div class="text-gray-400 fw-bold w-200px">Product Category</div>
                                                                <!--end::Label-->
                                                                <!--begin::Value-->
                                                            ...
                                                            <div class="d-flex mb-3">
                                                                <!--begin::Label-->
                                                                <div class="text-gray-400 fw-bold w-200px">Sub Total</div>
                                                                <!--end::Label-->
                                                                <!--begin::Value-->
                                                                <div class="text-gray-800 fw-bold">${{App\Helpers\Helper::subTotal($item->quantity, $item->product->amount)}}</div>
                                                                <!--end::Value-->
                                                            </div>
                                                            <!--end::Item-->
                                                        </div>
